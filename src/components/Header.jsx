...
// const projectStats = [
//   { title: "HealTogether", stars: 120, contributors: 5 },
//   { title: "MindTrack", stars: 85, contributors: 3 },
//   { title: "WellnessAI", stars: 95, contributors: 4 },
// ];
...
//           className="bg-gray-700 rounded-2xl p-4 sm:p-6 shadow-lg flex flex-col justify-between"
//         >
//           <div>
...
//             className="text-indigo-500 hover:underline mt-2 text-sm md:text-base"
//           >
//             View Repo
//           </a>
//         </motion.div>
